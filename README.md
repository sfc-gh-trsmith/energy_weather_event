...
This repository contains data models, sample data, and Cortex Analyst semantic models for simulating weather-driven risks in the energy industry. The initial implementation focuses on **Oil & Gas** scenarios, with Utilities scenarios to follow.
...
├── README.md                           # This file
├── requirements.*.md                   # Product requirement documents
├── sql/                                # Snowflake DDL and data loading scripts
│   ├── 00_setup.sql                    # Database, schema, role, warehouse setup
│   ├── 01_shared_dimensions.sql        # Shared dimension tables
│   ├── 02_shared_facts.sql             # Shared fact tables (weather)
│   ├── 03_scenario_01a_project_risk.sql # Scenario 01a specific tables
│   ├── 04_load_shared_dimensions.sql   # Load reference data
│   ├── 05_load_scenario_01a_dimensions.sql # Load project dimensions
│   ├── 06_load_weather_facts.sql       # Generate weather forecast data
│   └── 07_load_scenario_01a_facts.sql  # Generate activity snapshots & delays
├── analyst/                            # Cortex Analyst semantic models
│   └── 01a_og_project_risk.yaml        # Semantic model for project risk scenario
...
### Utilities Scenarios (Planned)

1. **01b - Project Risk Assessment (Find)** - *Planned*
2. **02b - Asset & Inventory Readiness (Produce & Move)** - *Planned*

## Data Model Architecture

### Unified Dimensional Model

The solution uses a **unified dimensional model** with shared dimensions across all scenarios:
...
Three Cortex Analyst semantic models are available:
```
analyst/01a_og_project_risk.yaml
analyst/02a_og_asset_inventory.yaml
analyst/03_hedge_mismatch.yaml
```
...
Detailed product requirements are in:
- `requirements.01a_og_find.md` - Oil & Gas Project Risk Assessment
- `requirements.02a_og_produce_and_move.md` - Oil & Gas Asset & Inventory
- `requirements.03_hedge.md` - Hedge Mismatch Early Warning
